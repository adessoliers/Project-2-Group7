from flask import Flask, render_template, request, jsonify, redirect, abort, url_for, send_from_directory
import json
import os
import sqlalchemy
...
# Database Setup
#----------------------------------------------------------------------------
engine = create_engine("postgresql://postgres:password@localhost:5432/emissions_db")
...
aqi_good_bad = Base.classes.updated_annual_aqi
